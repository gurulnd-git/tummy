...
class YummyTummyColor {
  ...
  static final Color appRed = Color.fromRGBO(212, 20, 15, 1.0);
...
class AppColor{
  static final Color primary = Color.fromRGBO(212, 20, 15, 1.0);
...
class AppTheme{
  static final ThemeData apptheme = ThemeData(
      primarySwatch: YummyTummyColor.appRed,
      // fontFamily: 'HelveticaNeue',
      backgroundColor: YummyTummyColor.white,
      accentColor: YummyTummyColor.appRed,
      ...
      appBarTheme: AppBarTheme(
          ...
          iconTheme: IconThemeData(color: YummyTummyColor.appRed,),
          elevation: 0,
          textTheme:  TextTheme(
            title: TextStyle(
                color: Colors.black,
      ...
      colorScheme: ColorScheme(
          ...
          error: Colors.red,
          primary: YummyTummyColor.appRed,
          primaryVariant: YummyTummyColor.appRed,
